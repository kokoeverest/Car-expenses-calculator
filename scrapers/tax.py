...
car_data = {
    'obl': 'София', 
    'obs': 'Столична', # def municipality_selector
    'old': '1', # def age_convertor
    'euro': '7', # def euro_category_converter
    'kw': '74' # def hp_to_kw_converter
}
...
# post_response = requests.post(url, data=car_data)
# print(post_response.status_code)
# post_page = post_response.text
# post_soup = bs(post_page, 'html.parser')
# search = post_soup.find(class_='amount')
